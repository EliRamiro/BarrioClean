...
public class SoatActivity extends AppCompatActivity implements View.OnClickListener {

    @BindView(R.id.btn_cerrar)
    ImageView btn_cerrar;
    @BindView(R.id.img_soat)
    ImageView img_soat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_soat.setOnClickListener(this);
        btn_listo.setOnClickListener(this);
        if (!cred.getData(Preference.SOAT).isEmpty()) {
            img_soat.setImageBitmap(Image.convert(cred.getData(Preference.SOAT)));
        }
        if (getIntent() != null) {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.btn_cerrar:
                ...
                startActivity(new Intent(SoatActivity.this, DocumentActivity.class));
                break;
            case R.id.img_soat:
    ...
    private void galleryAddPic() {
        ...
        try {
            ...
            String soat = Image.convert(BitmapFactory.decodeFile(b64, options));
            cred.saveData(Preference.SOAT, soat);
            img_soat.setImageBitmap(Image.convert(soat));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    void updateSoat() {
        String url = ctx.getString(R.string.base_url) + ctx.getString(R.string.updateSoat);
        Log.i("updateSoat_url", url);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    try {
                        ...
                        if (resend.getIde_error() == 0) {
                            ...
                            if (fromMain) {
                                ...
                                new Utils().finishActivity(SoatActivity.this);
                            }
                        } else {
                            viewDialog.hideDialog(0);
            ...
            System.out.println("updateSoat_error: " + error.getMessage());
            viewDialog.hideDialog(0);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("soat", cred.getData(Preference.SOAT));
                return params;
            }
        };
